...
VlCoroutine Vfpmult___024root___eval_initial__TOP__Vtiming__1(Vfpmult___024root* vlSelf) {
    ...
    while ((! (fpmult_tb__DOT__fd ? feof(VL_CVT_I_FP(fpmult_tb__DOT__fd)) : true))) {
        ...
        vlSelfRef.fpmult_tb__DOT__round_mode = (3U 
                                                & (IData)(
        ...
        vlSelfRef.fpmult_tb__DOT__round_in = vlSelfRef.fpmult_tb__DOT__round_mode;
        ...
        vlSelfRef.fpmult_tb__DOT__round_in = 0U;
...
void Vfpmult___024root___nba_sequent__TOP__0(Vfpmult___024root* vlSelf) {
    ...
    if (vlSelfRef.fpmult_tb__DOT__rst_in_N) {
            ...
            if (vlSelfRef.fpmult_tb__DOT__dut__DOT__done) {
                if ((0U != (IData)(vlSelfRef.fpmult_tb__DOT__dut__DOT__oor_found))) {
                    ...
                    vlSelfRef.fpmult_tb__DOT__dut__DOT__fix_exp 
                        = ((0x017dU < (IData)(vlSelfRef.fpmult_tb__DOT__dut__DOT__true_exp))
                            ? 0x000000ffU : ((0x007fU 
                                              > (IData)(vlSelfRef.fpmult_tb__DOT__dut__DOT__true_exp))
                                              ? 0U : 
                                             (0x000000ffU 
                                              & ((IData)(vlSelfRef.fpmult_tb__DOT__dut__DOT__true_exp) 
                                                 - (IData)(0x7fU)))));
                                               ...
                                               | (0x0000007fU 
                                                  & ((0x017dU 
                                                     ...
                                                     ((IData)(vlSelfRef.fpmult_tb__DOT__dut__DOT__rd__DOT__is_subnormal)
                                                       ? 
                                                      ((0x0010U 
                                                        <= (IData)(vlSelfRef.fpmult_tb__DOT__dut__DOT__rd__DOT__shift_amt))
                                                        ? 
                                                       (((0U 
                                                          == (IData)(vlSelfRef.fpmult_tb__DOT__dut__DOT__round_reg))
                                                       ...
                                                       (0x0000007fU 
                                                        & (((0x007fU 
                                                             >= (IData)(vlSelfRef.fpmult_tb__DOT__dut__DOT__rd__DOT__unround_exp))
                                                             ? 
                                                            VL_SHIFTR_III(16,16,10, 
                                                                          (0x0000ffffU 
                                                                           & vlSelfRef.fpmult_tb__DOT__dut__DOT__mc__DOT__fm__DOT__acc_reg), (IData)(vlSelfRef.fpmult_tb__DOT__dut__DOT__rd__DOT__shift_amt))
                                                             : 
                                                            VL_SHIFTL_III(16,16,10, vlSelfRef.fpmult_tb__DOT__dut__DOT__mc__DOT__fm__DOT__acc_reg, (IData)(vlSelfRef.fpmult_tb__DOT__dut__DOT__rd__DOT__shift_amt))) 
                                                           >> 7U)))
                                                       : 
                                                      ((0x00000100U 
                                                        & (IData)(vlSelfRef.fpmult_tb__DOT__dut__DOT__rd__DOT__bm))
                                                        ? 
                                                       ((IData)(vlSelfRef.fpmult_tb__DOT__dut__DOT__rd__DOT__bm) 
                                                        >> 1U)
                                                        : (IData)(vlSelfRef.fpmult_tb__DOT__dut__DOT__rd__DOT__bm)))))));
        ...
        vlSelfRef.fpmult_tb__DOT__valid_out = 0U;
        vlSelfRef.fpmult_tb__DOT__dut__DOT__exponent = 0U;
    }
    vlSelfRef.fpmult_tb__DOT__dut__DOT__mc__DOT__fm__DOT__acc_reg 
        = __Vdly__fpmult_tb__DOT__dut__DOT__mc__DOT__fm__DOT__acc_reg;
    ...
    if (vlSelfRef.fpmult_tb__DOT__rst_in_N) {
        if (vlSelfRef.fpmult_tb__DOT__start_in) {
            ...
            vlSelfRef.fpmult_tb__DOT__dut__DOT__sign 
                = (1U & (((IData)(vlSelfRef.fpmult_tb__DOT__x_in) 
                          ^ (IData)(vlSelfRef.fpmult_tb__DOT__y_in)) 
                         >> 0x0fU));
            vlSelfRef.fpmult_tb__DOT__dut__DOT__round_reg 
                = vlSelfRef.fpmult_tb__DOT__round_in;
        ...
        vlSelfRef.fpmult_tb__DOT__dut__DOT__round_reg = 0U;
